...
/**
 * @title Airdrop
 * @dev Gas-efficient airdrop contract for native XTZ token distribution
 * @notice Anyone can use this contract to batch transfer XTZ tokens from their wallet to multiple addresses
