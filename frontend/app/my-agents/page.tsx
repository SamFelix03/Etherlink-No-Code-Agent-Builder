        ...
        <div className="mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Manage and interact with your Etherlink agents
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Create your first Etherlink agent to get started with workflow automation
            </p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <pre className="p-4 bg-muted rounded-md border overflow-x-auto text-xs">
                  <code>{`curl -X POST https://etherlink-agent-builder.vercel.app/api/agent/chat \\
  ...
  -d '{
    ...
    "user_message": "your_message_here"
                ...
                <Button
                  ...
                  onClick={() => {
                    const curlCommand = `curl -X POST https://etherlink-agent-builder.vercel.app/api/agent/chat \\
  -H "Content-Type: application/json" \\
  -d '{
    "api_key": "${selectedAgentForExport?.api_key || 'YOUR_API_KEY'}",
    "user_message": "your_message_here"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <pre className="p-4 bg-muted rounded-md border overflow-x-auto text-xs">
                  <code>{`const response = await fetch('https://etherlink-agent-builder.vercel.app/api/agent/chat', {
  method: 'POST',
  headers: {
...
console.log(data);`}</code>
                ...
                <Button
                  ...
                  className="absolute top-2 right-2"
                  onClick={() => {
                    const jsCode = `const response = await fetch('https://etherlink-agent-builder.vercel.app/api/agent/chat', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
  },
